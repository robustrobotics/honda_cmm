...
from learning.jointsplot import scatter_contexts, contexts_by_moment
...
def main():
    train_dataset = JointsDataset(fname='ns_data/dataset.pkl')

    n_test_datasets = args.n_datasets // 10
    test_dataset = JointsDataset(fname='ns_data/dataset.pkl')
